...
@interface PSPDFSignatureContainer (Deprecated)

/// Designated initializer.
- (instancetype)initWithAnnotation:(PSPDFInkAnnotation *)annotation signer:(nullable PSPDFSigner *)signer biometricProperties:(nullable PSPDFSignatureBiometricProperties *)biometricProperties PSPDF_DEPRECATED(10.3, 5.3, "Use init(signatureAnnotation:) instead");

/// Ink annotation that is used for signing a document.
@property (nonatomic, nullable, readonly) PSPDFInkAnnotation *annotation PSPDF_DEPRECATED(10.3, 5.3, "Use signatureAnnotation instead");
