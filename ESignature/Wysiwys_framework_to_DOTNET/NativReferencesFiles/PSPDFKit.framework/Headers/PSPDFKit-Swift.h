...
/// Record an undoable command with the given localized title and actions
...
/// \param title Localized title of the command that will be used in UI. To
...
///
- (void)recordCommandNamed:(NSString * _Nullable)title inScope:(SWIFT_NOESCAPE void (^ _Nonnull)(id <PSPDFUndoRecorder> _Nonnull))scope;
/// Record an undoable command with the given localized title, recording
...
///
- (void)recordCommandNamed:(NSString * _Nullable)title changingAnnotations:(NSArray<PSPDFAnnotation *> * _Nonnull)annotations inScope:(SWIFT_NOESCAPE void (^ _Nonnull)(void))scope;
/// Record an undoable command with the given localized title, recording
...
///
- (void)recordCommandNamed:(NSString * _Nullable)title addingAnnotations:(NSArray<PSPDFAnnotation *> * _Nonnull)annotations inScope:(SWIFT_NOESCAPE void (^ _Nonnull)(void))scope;
/// Record an undoable command with the given localized title, recording
...
///
- (void)recordCommandNamed:(NSString * _Nullable)title removingAnnotations:(NSArray<PSPDFAnnotation *> * _Nonnull)annotations inScope:(SWIFT_NOESCAPE void (^ _Nonnull)(void))scope;
/// Begin recording an undoable command with the given localized title and
...
- (id <PSPDFDetachedUndoRecorder> _Nonnull)beginRecordingCommandNamed:(NSString * _Nullable)title SWIFT_WARN_UNUSED_RESULT;
/// Begin recording an undoable command with the given localized title,
...
- (id <PSPDFPendingUndoRecorder> _Nonnull)beginRecordingCommandNamed:(NSString * _Nullable)title changingAnnotations:(NSArray<PSPDFAnnotation *> * _Nonnull)annotations SWIFT_WARN_UNUSED_RESULT;
@end
...
/// @note <code>URLSessionConfiguration</code> cannot be serialized via NSCoder and is ignored.
