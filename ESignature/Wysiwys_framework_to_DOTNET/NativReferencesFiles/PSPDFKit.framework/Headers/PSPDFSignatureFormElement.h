...
@interface PSPDFSignatureFormElement (Deprecated)
...
@property (atomic, readonly, nullable) PSPDFInkAnnotation *overlappingInkSignature PSPDF_DEPRECATED(10.3, 5.3, "Use `overlappingSignatureAnnotation` instead");
@end
