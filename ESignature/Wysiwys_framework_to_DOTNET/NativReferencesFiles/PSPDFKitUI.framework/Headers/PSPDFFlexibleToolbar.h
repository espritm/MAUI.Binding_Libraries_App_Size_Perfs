...
/// Defaults to the`standardAppearance.backgroundColor` on iOS 13 onwards and `barTintColor` on earlier versions if available, otherwise an attempt is made to select an appropriate color
