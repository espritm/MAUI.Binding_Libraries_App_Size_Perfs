...
@property (nonatomic) PSPDFTabbedBarStyle tabbedBarStyle UI_APPEARANCE_SELECTOR PSPDF_DEPRECATED_IOS(10.5, "On iOS 13 and above, the bar is styled based on the `traitCollection`’s `userInterfaceStyle`.");
