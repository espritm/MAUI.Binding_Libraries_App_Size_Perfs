...
/// The `identifier` property of the `PSPDFMenuItem` object is not localized and perfect for comparison.
...
/// components to set up relationships with the internal gesture recognizers. For
/// more information, check out the migration guide:
/// https://pspdfkit.com/guides/ios/migration-guides/pspdfkit-9-5-migration-guide
