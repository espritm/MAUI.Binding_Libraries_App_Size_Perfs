...
- (void)annotationStyleController:(PSPDFAnnotationStyleViewController *)styleController willStartChangingProperty:(NSString *)propertyName PSPDF_DEPRECATED(10.4, 5.4, "Use `annotationStyleController(_:didBeginChangingProperty:)` instead.");

/// Called when a user finishes changing a property (e.g. slider touch up)
///
/// @note Will not be fired for all properties.
- (void)annotationStyleController:(PSPDFAnnotationStyleViewController *)styleController didEndChangingProperty:(NSString *)propertyName PSPDF_DEPRECATED(10.4, 5.4, "Use `annotationStyleController(_:didEndChangingProperty:affectedProperties:)` instead.");
