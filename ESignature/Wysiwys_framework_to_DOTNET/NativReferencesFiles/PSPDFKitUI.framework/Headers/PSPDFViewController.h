...
@class PSPDFPageGrabberController;
...
@property (nonatomic, readonly, nullable) PSPDFPageGrabberController *pageGrabberController PSPDF_DEPRECATED_IOS(10.5, "Deprecated in PSPDFKit 10.5 for iOS because the scroll indicator from `UIScrollView` supports dragging on iOS 13 and later.");
